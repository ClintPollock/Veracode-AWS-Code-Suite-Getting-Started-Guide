...
![AWS Code](1-InitialSetup/images/2-AWSCloud9.png)
...
![AWS Code](1-InitialSetup/images/3-AWSCloud9.png)
...
![AWS Code](1-InitialSetup/images/5-AWSCloud9.png)
...
![AWS Code](1-InitialSetup/images/6-AWSCloud9.png)

Click on CodeBuild on the left navigation menu.

![AWS Code](1-InitialSetup/images/8-AWSCodeBuild.png)


![AWS Code](1-InitialSetup/images/9-AWSCodeBuild.png)

Point this build project to the PetStoreAPI CodeCommit Repo.

![AWS Code](1-InitialSetup/images/AWSCodeCommitEditSource.png)

Use the managed image option with the below settings.

![AWS Code](1-InitialSetup/images/17AWSCodeBuild.png)

![AWS Code](1-InitialSetup/images/20-AWSCodeBuild.png)
...
![AWS Code](1-InitialSetup/images/21-AWSCodeBuild.png)
...
![AWS Code](1-InitialSetup/images/22-AWSCodeBuild.png)

Everything else is default. Create the Build Project, and then start the project to see if it works.

![AWS Code](1-InitialSetup/images/23-AWSCodeBuild.png)

Here you can see the artifact in your S3 bucket.

![AWS Code](1-InitialSetup/images/24-AWSCodeBuild.png)
